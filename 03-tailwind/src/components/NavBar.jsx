...
const NavBar = () => {
	return <header className="sticky top-0 flex items-center justify-between py-1.5 px-3 backdrop-blur-sm bg-linear-to-t from-transparent to-emerald-100 border-b border-b-emerald-100">
